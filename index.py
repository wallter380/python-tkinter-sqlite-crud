...
class Product:
    ...
    def __init__(self, window):
        # Initializations 
        self.wind = window
        self.wind.title('Gestor de productos')
    ...
    def delete_product(self):
        ...
        try:
           self.tree.item(self.tree.selection())['text'][0]
            ...
            self.message['text'] = 'Porfavor elegir producto'
            return
        self.message['text'] = ''
    ...
    def edit_product(self):
        ...
        try:
            ...
            self.message['text'] = 'Porfavor, selecciona producto'
            return
        name = self.tree.item(self.tree.selection())['text']
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = 'Producto {} se modifico satisfactoria'.format(name)
        self.get_products()
